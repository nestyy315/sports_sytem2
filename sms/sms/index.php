...
if ($role === 'admin') {
    $allowed_pages = [
        ...
        'admin_facilitators' => '../MAIN/roles/admin_/facilitators.php',
        // 'admin_registration' => '../MAIN/roles/admin_/registrations.php',
        'admin_tryouts' => '../MAIN/roles/admin_/tryout_registrations.php',
        'admin_coaches' => '../MAIN/roles/admin_/coaches.php',
    ...
    $sidebar_items = [
        ...
        ['name' => 'Facilitators', 'icon' => 'fa-solid fa-clipboard-list', 'page' => 'admin_facilitators'],
        ['name' => 'Tryouts Registration', 'icon' => 'fa-solid fa-clipboard-list', 'page' => 'admin_tryouts'],
        ['name' => 'Coaches', 'icon' => 'fa-solid fa-clipboard-list', 'page' => 'admin_coaches'],
